...
tippecanoe: geojson.o jsonpull/jsonpull.o tile.o pool.o mbtiles.o pmtiles.o geometry.o projection.o memfile.o mvt.o serial.o main.o text.o dirtiles.o plugin.o read_json.o write_json.o geobuf.o flatgeobuf.o evaluator.o geocsv.o csv.o geojson-loop.o json_logger.o
